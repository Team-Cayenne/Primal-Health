...
const LandingPage= () =>{
  ...
  return (
    <LandingPageContainer>
      ...
      <Main>
        <img src={'/assets/landingpage/newMainTest.jpeg'} width="414" height="412" ></img>
        <MainTextContainer>
      ...
      <MealSelection>
        <Top>
          <Image src='assets/landingpage/whole30.png' width="281" height="418" ></Image>
          <Image src='assets/landingpage/vegetarian.png' width="281" height="418"></Image>
          <Image src='assets/landingpage/pescatarian.png' width="281" height="418"></Image>
        </Top>
        <Bottom>
          <Image src='assets/landingpage/vegan.png' width="281" height="418"></Image>
          <Image src='assets/landingpage/paleo.png' width="281" height="418"></Image>
          <Image src='assets/landingpage/keto.png' width="281" height="418"></Image>
        </Bottom>
      </MealSelection>
